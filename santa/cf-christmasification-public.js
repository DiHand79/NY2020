(function ($) {
  ...
  $.fn.christmasify = function (options) {
    ...
    if (settings.music) {
      $('body').append('<audio id="christmas-music" controls autoplay="autoplay" loop><source src="' + settings.music + '" type="audio/mpeg">Your browser does not support the audio element.</audio>');
